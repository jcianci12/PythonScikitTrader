...
MAXBUYPERCENTOFCAPITAL = decimal.Decimal(20)
MAXSELLPERCENTOFCAPITAL = decimal.Decimal(20)
...
ORDERCSVFIELDNAMES= ['uid', 'date','symbol', 'side', 'qty', 'entryprice', 'takeprofitprice', 'stoplossprice','exitprice', 'profit']
