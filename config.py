...
ORDERCOLUMNS = ['uid', 'date','symbol', 'side',"usdt","btc", 'qty', 'entryprice', 'takeprofitprice', 'stoplossprice', 'takeprofitid', 'stoplossid', 'profit', 'completedtime','exitprice']
